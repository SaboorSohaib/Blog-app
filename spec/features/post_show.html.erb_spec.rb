...
RSpec.describe 'PostShow', type: :feature do
  describe 'Post Show Page' do
    before(:each) do
      @user1 = User.create!(name: 'Ali', photo: 'https://unsplash.com/photos/WNoLnJo7tS8', posts_counter: 1,
                            bio: 'developer')
      @user2 = User.create!(name: 'Abid', photo: 'https://unsplash.com/photos/WNoLnJo7tS8', posts_counter: 2,
                            bio: 'Engineer')
      ...
      @post2 = Post.create!(title: 'Criket', text: 'He likes criket', comments_counter: 4,
                            likes_counter: 4, author_id: @user2.id)
